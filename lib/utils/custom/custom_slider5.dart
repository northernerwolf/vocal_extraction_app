...
class VerticalCustomSlider5 extends StatefulWidget {
  @override
  _VerticalCustomSlider5State createState() => _VerticalCustomSlider5State();
}

class _VerticalCustomSlider5State extends State<VerticalCustomSlider5> {
