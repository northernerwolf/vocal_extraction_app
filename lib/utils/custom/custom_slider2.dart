...
class VerticalCustomSlider2 extends StatefulWidget {
  @override
  _VerticalCustomSlider2State createState() => _VerticalCustomSlider2State();
}

class _VerticalCustomSlider2State extends State<VerticalCustomSlider2> {
